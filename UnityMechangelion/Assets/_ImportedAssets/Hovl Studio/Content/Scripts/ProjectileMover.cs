...
public class ProjectileMover : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (this.flash != null)
        {
            ...
            var flashInstance = Instantiate(this.flash, this.transform.position, Quaternion.identity);
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (this.hit != null)
        {
            var hitInstance = Instantiate(this.hit, pos, rot);
        ...
        foreach (var detachedPrefab in this.Detached)
        {
