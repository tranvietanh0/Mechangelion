...
- **Any command that updates `.claude/skills/`** → ALWAYS invoke `/t1k:sync-back` skill (NEVER manually copy to kit repos)
- **Any command that discovers a skill bug** → ALWAYS invoke `/t1k:issue` skill (NEVER manually create issues)
