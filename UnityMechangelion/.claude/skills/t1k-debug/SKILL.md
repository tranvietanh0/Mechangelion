---
name: t1k:debug
description: "Investigate and diagnose errors via registry-routed debugger agent. Root cause first, no fixes until cause confirmed. Use for runtime errors, crashes, wrong output, test failures, performance issues, CI/CD failures, log analysis."
version: 2.0.0
